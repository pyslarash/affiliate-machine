...
class UserEnv(db.Model):
    ...
    domdetailer_api_key = Column(String)
...
class AvailableDomains(db.Model):
    ...
    moz_links = Column(Integer)
    moz_rank = Column(DECIMAL(10, 2))
    moz_trust = Column(DECIMAL(10, 2))
    moz_spam = Column(DECIMAL(10, 2))
    fb_comments = Column(Integer)
    fb_shares = Column(Integer)
    stumbles = Column(Integer)
    pinterest_pins = Column(Integer)
    majestic_stat = Column(String)
    majestic_links = Column(Integer)
    majestic_ref_domains = Column(Integer)
    majestic_ref_edu = Column(Integer)
    majestic_ref_gov = Column(Integer)
    majestic_ref_subnets = Column(Integer)
    majestic_ips = Column(Integer)
    majestic_cf = Column(Integer)
    majestic_tf = Column(Integer)
    majestic_ttf0_name = Column(String)
    majestic_ttf0_value = Column(Integer)
    majestic_ttf1_name = Column(String)
    majestic_ttf1_value = Column(Integer)
    majestic_ttf2_name = Column(String)
    majestic_ttf2_value = Column(Integer)
