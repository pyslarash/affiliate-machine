    ...
    with current_app.app_context():
        ...
        for domain in available_domains:
            result.append({
                ...
                'ahrefs_dr': domain.ahrefs_dr,
                'ahrefs_eb': domain.ahrefs_eb,
                'ahrefs_rd': domain.ahrefs_rd,
                'ahrefs_dofollow': domain.ahrefs_dofollow,
                'ahrefs_ips': domain.ahrefs_ips,
                'semrush_rank': domain.semrush_rank,
                'semrush_keywords': domain.semrush_keywords,
                'fb_comments': domain.fb_comments,
                'fb_shares': domain.fb_shares,
                'fb_reactions': domain.fb_reactions,
